        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    MinutesRead = table.Column<int>(type: "integer", nullable: false),
                    PagesRead = table.Column<int>(type: "integer", nullable: false),
                    BooksCompleted = table.Column<int>(type: "integer", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_DailyReadingStats", x => x.Id);
                    table.ForeignKey(
                        name: "FK_DailyReadingStats_AspNetUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<Guid>(type: "uuid", nullable: false),
                    UserId = table.Column<Guid>(type: "uuid", nullable: false),
                    ReceiveNewBookNotifications = table.Column<bool>(type: "boolean", nullable: false),
                    ReceiveFriendActivityNotifications = table.Column<bool>(type: "boolean", nullable: false),
                    ReceiveWeeklySummaryEmail = table.Column<bool>(type: "boolean", nullable: false),
                    DailyReadingGoalMinutes = table.Column<int>(type: "integer", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    UserId = table.Column<Guid>(type: "uuid", nullable: false),
                    BookId = table.Column<Guid>(type: "uuid", nullable: false),
                    ReadingProgressPercent = table.Column<double>(type: "double precision", nullable: false),
                    LastReadPageNumber = table.Column<int>(type: "integer", nullable: false),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_DailyReadingStats_UserId_Date",
                table: "DailyReadingStats",
